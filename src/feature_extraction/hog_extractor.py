...
class HOGExtractor:
    ...
    def _calculate_feature_size(self) -> int:
        ...
        This is based on the window size and HOG parameters.
        ...
        total_features = n_blocks_x * n_blocks_y * features_per_block
    ...
    def extract_features(self, window: np.ndarray) -> np.ndarray:
        ...
        try:
            ...
            # Validate output
            if len(features) == 0:
                logger.warning("HOG extraction returned empty feature vector")
